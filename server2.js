...
http.createServer((req, res) => {
  if (req.url === '/paises') {
    ...
    fs.readFile(pathToFile, (err, data) => {
      ...
      // Filtra os pega apenas os primeiros 20
      const paisesFiltrados = paises.slice(0, 20);

      // Gera a resposta HTTP com o conteúdo JSON dos países filtrados
      res.statusCode = 200;
      res.end(JSON.stringify(paisesFiltrados));
    });
  } 
